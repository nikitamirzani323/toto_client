      ...
      <table class="table table-dark table-striped table-sm">
        <thead>
          <tr>
            <th
              width="10%"
              style="vertical-align:top;background:#303030;font-size:13px;border-bottom:none;"
              NOWRAP>NOMOR</th
            >
            <th
              width="20%"
        ...
        <tbody>
          {#each keranjang as rec}
            <tr>
              <td style="vertical-align:top;font-size:12px;color:#fc0;"
                >{rec.nomor}</td
              >
              <td style="vertical-align:top;font-size:12px;color:#fc0;"
                >{rec.permainan}</td
      ...
      >
        ...
        <tr>
          <td style="color:white;"
            >4D : <span style="color:#f7941d;">{count_line_4d}</span></td
          >
          <td style="color:white;"
            >3D : <span style="color:#f7941d;">{count_line_3d}</span></td
          >
          <td style="color:white;"
            >2D : <span style="color:#f7941d;">{count_line_2d}</span></td
          >
          <td style="color:white;"
            >2D DEPAN : <span style="color:#f7941d;">{count_line_2dd}</span></td
          >
          <td style="color:white;"
            >2D TENGAH : <span style="color:#f7941d;">{count_line_2dt}</span
            ></td
          >
        </tr>
      </table>
    {:else}
      ...
      >
        ...
        <tr>
          ...
          >
          <td style="color:white;"
            >2DD : <span style="color:#f7941d;">{count_line_2dd}</span></td
          >
          <td style="color:white;"
            >2DT : <span style="color:#f7941d;">{count_line_2dt}</span></td
          >
        </tr>
      </table>
    {/if}
